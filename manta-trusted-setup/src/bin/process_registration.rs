...
// run with
// cargo run --release --package manta-trusted-setup --all-features --bin process_registration -- process /Users/thomascnorton/Downloads/Trusted_Setup_Signups /Users/thomascnorton/Documents/Manta/manta-rs/manta-trusted-setup/data/test_registry.csv
...
fn test_extract_registry() {
    ...
    let file =
        File::open("/Users/thomascnorton/Downloads/Trusted Setup Signups - Trusted Setup (2).csv")
