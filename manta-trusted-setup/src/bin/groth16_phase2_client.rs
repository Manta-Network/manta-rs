...
use manta_trusted_setup::ceremony::{
    client::{contribute, handle_error, register, Error},
    config::g16_bls12_381::{Config, Groth16BLS12381},
};
            ...
            Command::Contribute => {
                    ...
                    .build()
                {
                    Ok(runtime) => runtime.block_on(async {
                        contribute::<Groth16BLS12381, ark_bls12_381::Bls12_381, Config, 3>().await
                    }),
