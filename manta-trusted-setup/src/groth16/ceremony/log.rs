...
macro_rules! log_macro {
    ($level:expr, $($expr:expr),*) => {{
        $crate::groth16::ceremony::log::log(&mut $crate::groth16::ceremony::log::stdout(), $level, format!($($expr),*)).await
    }}
}
...
macro_rules! trace_macro {
    ($($expr:expr),*) => {{
        $crate::groth16::ceremony::log::log!($crate::groth16::ceremony::log::Level::Trace, $($expr),*)
    }}
}
...
macro_rules! info_macro {
    ($($expr:expr),*) => {{
        $crate::groth16::ceremony::log::log!($crate::groth16::ceremony::log::Level::Info, $($expr),*)
    }}
}
...
macro_rules! warn_macro {
    ($($expr:expr),*) => {{
        $crate::groth16::ceremony::log::log!($crate::groth16::ceremony::log::Level::Warn, $($expr),*)
    }}
}
...
macro_rules! error_macro {
    ($($expr:expr),*) => {{
        $crate::groth16::ceremony::log::log!($crate::groth16::ceremony::log::Level::Error, $($expr),*)
    }}
}
