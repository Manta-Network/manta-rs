...
pub mod unverified_transfers {
    ...
    use super::{*, utxo::auth::VerifySignature};
...
#[derivative(
    ...
    PartialEq(bound = "AuthorizationSignature<C>: PartialEq, UnsafeTransferPostBody<C>: PartialEq")
)]
...
/// Unsafe Transfer Posting Key
pub struct UnsafeTransferPostingKey<C, L>
where
    C: Configuration + ?Sized,
    L: TransferLedger<C>,
{
...
impl<C, L> UnsafeTransferPostingKey<C, L>
where
    C: Configuration + ?Sized,
    L: TransferLedger<C>,
{
