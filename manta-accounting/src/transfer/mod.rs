...
#[derivative(
    Clone(
        bound = "Authorization<C>: Clone, C::AssetId: Clone, C::AssetValue: Clone, Sender<C>: Clone, Receiver<C>: Clone"
    ),
    Copy(
        bound = "Authorization<C>: Copy, C::AssetId: Copy, C::AssetValue: Copy, Sender<C>: Copy, Receiver<C>: Copy"
    ),
    Debug(
        bound = "Authorization<C>: Debug, C::AssetId: Debug, C::AssetValue: Debug, Sender<C>: Debug, Receiver<C>: Debug"
    ),
    Eq(
        bound = "Authorization<C>: Eq, C::AssetId: Eq, C::AssetValue: Eq, Sender<C>: Eq, Receiver<C>: Eq"
    ),
    Hash(
        bound = "Authorization<C>: Hash, C::AssetId: Hash, C::AssetValue: Hash, Sender<C>: Hash, Receiver<C>: Hash"
    ),
    PartialEq(
        bound = "Authorization<C>: PartialEq, C::AssetId: PartialEq, C::AssetValue: PartialEq, Sender<C>: PartialEq, Receiver<C>: PartialEq"
    )
)]
pub struct Transfer<
    C,
...
#[derivative(
    Clone(
        bound = "AuthorizationVar<C>: Clone, C::AssetIdVar: Clone, C::AssetValueVar: Clone, SenderVar<C>: Clone, ReceiverVar<C>: Clone"
    ),
    Debug(
        bound = "AuthorizationVar<C>: Debug, C::AssetIdVar: Debug, C::AssetValueVar: Debug, SenderVar<C>: Debug, ReceiverVar<C>: Debug"
    ),
    Eq(
        bound = "AuthorizationVar<C>: Eq, C::AssetIdVar: Eq, C::AssetValueVar: Eq, SenderVar<C>: Eq, ReceiverVar<C>: Eq"
    ),
    Hash(
        bound = "AuthorizationVar<C>: Hash, C::AssetIdVar: Hash, C::AssetValueVar: Hash, SenderVar<C>: Hash, ReceiverVar<C>: Hash"
    ),
    PartialEq(
        bound = "AuthorizationVar<C>: PartialEq, C::AssetIdVar: PartialEq, C::AssetValueVar: PartialEq, SenderVar<C>: PartialEq, ReceiverVar<C>: PartialEq"
    )
)]
struct TransferVar<
    C,
...
#[cfg_attr(
    ...
    serde(
        bound(
            deserialize = "InvalidAuthorizationSignature: Deserialize<'de>, InvalidSourceAccount<C, AccountId>: Deserialize<'de>, 
            InvalidSinkAccount<C, AccountId>: Deserialize<'de>, SenderPostError: Deserialize<'de>, ReceiverPostError: Deserialize<'de>,
            UpdateError: Deserialize<'de>",
            serialize = "InvalidAuthorizationSignature: Serialize, InvalidSourceAccount<C, AccountId>: Serialize, 
            InvalidSinkAccount<C, AccountId>: Serialize, SenderPostError: Serialize, ReceiverPostError: Serialize,
