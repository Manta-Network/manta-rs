...
use crate::{
    ...
    transfer::{
        ...
        utxo::{
            self, auth::DeriveContext, DeriveDecryptionKey, DeriveSpend, Spend, UtxoReconstruct,
        },
...
use super::signer::{
    IdentityResponse, SignError, SignResponse, SignerParameters, SyncData, SyncError, SyncRequest,
    ...
    C: Configuration,
{
    ...
    let (final_presenders, utxo_accumulator) = prepare_final_pre_senders(
        accounts,
        assets,
        utxo_accumulator,
        parameters,
...
where
    C: Configuration,
{
    /// Builds a new [`Signer`] from `parameters`.
    #[inline]
