...
use crate::{
    ...
    identity2::{self, PreSender, PublicKey, SecretKey, Utxo},
    key2::{Account, HierarchicalKeyTable},
    transfer2::{
        self,
...
pub trait Configuration: transfer2::Configuration {
