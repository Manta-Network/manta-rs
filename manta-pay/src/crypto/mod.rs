...
#[cfg(test)]
mod test {
    use crate::config::utxo::{v1::IncomingBaseEncryptionScheme, v2::IncomingBaseAES};
    use manta_accounting::transfer::utxo::v2::IncomingPlaintext;
    use manta_crypto::{
    ...
    fn note_symmetric_encryption_100_000_times() {
        ...
        encryption::test::decrypt_only::<IncomingBaseAES>(
            &rng.gen(),
            &enc_vec,
            &dec_vec,
            &(),
